...
#[주의할점] 문자열과 숫자에 + 연산이 안됨
#제발 변수명으로 str/date 등 안됨
d = dokdo + str(100)
print(d)
#str = '우리 땅'
#d = a + str(100)
...
"""
print(msg[3:]) #3번쨰부터 끝까지~
print(msg[:5]) #처음부터 5번전까지~
# 1) 5번째부터
print(msg[5:])
# 2) 5번째 전의 문자까지
print(msg[:5])
...
print(date[:4] + '년' + date[5:7] + '월' +date[8:10] + '일')
print(date[13:15] + '시' + date[17:18] + '분')
